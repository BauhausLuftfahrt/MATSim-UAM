...
public class UAMStationConnectionGraph {
	...
	// TODO this class should store the distance each pair of stations for each
	// vehicle, e.g.:
	// private Map<Map<Id<UAMStation>, Id<UAMStation>>, Map<Id<UAMVehicle>, Double>>
	// travelTimes;
		...
		for (UAMStation uamStationOrigin : uamManager.getStations().stations.values()) {
			for (UAMStation uamStationDestination : uamManager.getStations().stations.values()) {
				...
				try {
					...
					if (parameters != null)
						utility = estimateUtilityUAM(travelTime, distance, parameters, uamStationOrigin,
								uamStationDestination);
	...
	/**
	 * @param travelTime Travel time between two UAM stations.
	 * @param distance Distance between two UAM stations.
	 * @param parameters Parameters for utility calculation
	 * @param stationOrigin Origin UAM Station
	 * @param stationDestination Destination UAM Station
	 * @return utility between two UAM Stations
	 */
