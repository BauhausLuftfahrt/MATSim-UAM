...
public class UAMVehicle extends VehicleImpl {
	...
	public UAMVehicle(Id<Vehicle> id, Id<UAMStation> stationId, Link startLink,
					  double capacity, double t0, double t1, double width, double length, double range, UAMVehicleType vehicleType) {
	...
	public UAMVehicle(Id<Vehicle> id, Id<UAMStation> stationId, Link startLink, double capacity, double t0, double t1, UAMVehicleType vehicleType) {
	...
	/**
	 * This method is used to retrieve the vehicle vertical speed during take-off and landing.
	 *
	...
	/**
	 * This method is used to retrieve the Time for the passenger to board in the aircraft in seconds. Used in the <code>UAMPickUpTask</code>.
	 *
	...
	/**
	 * This method is used to retrieve the Time for the passenger to board off from the aircraft in seconds. Used in the <code>UAMDropOffTask</code>.
	 *
	...
	/**
	 * This method is used to retrieve the Time needed for the UAM Vehicle to perform the <code>TurnAroundTask</code> (unavailable for other trips after landing)
	 *
	 * @return the UAM Vehicle turn around time (time unavailable for other trips after landing)
	 */
