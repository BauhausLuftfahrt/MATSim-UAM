...
public final class DefaultAnalysisMainModeIdentifier implements AnalysisMainModeIdentifier {
	...
	public DefaultAnalysisMainModeIdentifier() {
        ...
        modeHierarchy.add("access_uam_car");
        modeHierarchy.add("egress_uam_car");
        modeHierarchy.add("access_uam_walk");
        modeHierarchy.add("egress_uam_walk");
        modeHierarchy.add("access_uam_pt");
        modeHierarchy.add("egress_uam_pt");
        modeHierarchy.add("access_uam_bike");
        modeHierarchy.add("egress_uam_bike");
        modeHierarchy.add("access_uam_taxi");
        modeHierarchy.add("egress_uam_taxi");
        modeHierarchy.add("uam");
